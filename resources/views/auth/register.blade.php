...
<body>
    ...
    <div class="landing-hero">
        ...
        <div style="margin-bottom: 0px">
            {{-- <img alt="Logo" src="{{ asset('web_files/images/Tammy_logo-removebg-preview_1.png') }}"> --}}
        </div>
        <div class="container" style="display: flex; flex-direction: row; align-items: center; flex-wrap: wrap">
            <div
                style="col-sm-12 col-md-2 display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px;">
                <!-- Back to Home button -->
                <a href="/" class="btn btn-secondary" style="text-decoration: none; font-weight: bold;">
                    ← Back to Home
                </a>
            </div>
                ...
                <form action="{{ route('register') }}" method="POST">
                    ...
                    {{-- <div class="row">
                        <div class="col-md-6" style="padding-left: 0px;">
                            <label for="first_name">
                                First_Name:
                                <input id="first_name" name="first_name" placeholder="FirstName" required="required"
                                    type="text" />
                                @error('first_name')
                                    <span class="invalid-feedback" style="color: red; font-size: 12px" role="alert">
                                        <strong>{{ $message }}</strong>
                        ...
                        <div class="col-md-6" style="padding-right: 0px;">
                            <label for="last_name">
                                Last_Name:
                                <input id="last_name" name="last_name" placeholder="LastName" required="required"
                                    type="text" />
                                @error('last_name')
                                    <span class="invalid-feedback" style="color: red; font-size: 12px" role="alert">
                                        <strong>{{ $message }}</strong>
                    ...
                    <div class="row">
                        <div class="col-md-6" style="padding-left: 0;">
                            <label for="first_name" style="text-align: left;">
                                First_Name:
                                <input id="first_name" name="first_name" placeholder="FirstName" required="required"
                                    type="text" />
                            </label>
                        ...
                        <div class="col-md-6" style="padding-right: 0;">
                            <label for="last_name" style="text-align: left;">
                                Last_Name:
                                <input id="last_name" name="last_name" placeholder="LastName" required="required"
                                    type="text" />
                            </label>
                    ...
                    <div class="row">
                        <label for="repassword" style="text-align: left;">
                            re-type Password:
                            <input id="repassword" name="password_confirmation" placeholder="Re-type Password"
            ...
            <div
                style="col-sm-12 col-md-2 display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; margin-top: 20px">
                <a href="/login" class="btn btn-primary" style="text-decoration: none; font-weight: bold;">
                    Login →
                </a>
            </div>
