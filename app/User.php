...
class User extends Authenticatable
{
    ...
    public function filmClickHistories()
    {
        return $this->hasMany(FilmClickHistory::class);
    }
    public function filmSearchHistories()
    {
        return $this->hasMany(FilmSearchHistory::class);
    }
    public function filmFavourites()
    {
        return $this->hasMany(Favorite::class);
    }
}
